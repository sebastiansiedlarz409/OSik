...
gcc_flags = "-std=c99 -nostdlib -masm=intel -O3 -Wall -Wextra -mgeneral-regs-only -c -ggdb"
ld_flags = "-std=c99 -nostdlib -masm=intel -O3 -Wall -Wextra -s -ggdb -o kernel\kernel64"
